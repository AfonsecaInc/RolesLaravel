@extends('layouts.main', ['activePage' => 'posts', 'titlePage' => __('Listado de posts')])
@section('content')
    <div class="content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> Administración de post</p>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    <a rel="tooltip" class="btn btn-info btn-link"
                                                        href="{{ route('posts.show', $post->id) }}" data-original-title=""
                                                        title="Ver">
