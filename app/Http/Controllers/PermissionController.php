...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('permissions.index')->with(['success' => 'Permiso creado exitosamente', 'icon' => 'success']);
    }
    ...
    public function update(Request $request, Permission $permission)
    {
        ...
        return redirect()->route('permissions.show', $permission->id)->with(['success' => 'Actualizado correctamente', 'icon' => 'info']);
    }
